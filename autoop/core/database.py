...
class Database():
    """
    A class for a database. Provides methods to store, retrieve, delete,
    and list data organized into collections. Data is persisted
    ...
    def __init__(self, storage: Storage) -> None:
        """
        Initializes the class with a storage, and a data dictionary.

        Args:
            storage (Storage): Storage of a Storage class.
        """
